...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-1/2 translate-x-[-50%] bg-white dark:bg-[#333333] w-full z-50 flex items-center justify-between px-4 border-b-2  border-gray-300 py-4 lg:max-w-300 mx-auto">
        <Link
          href="/"
