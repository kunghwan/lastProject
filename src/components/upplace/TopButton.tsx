  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        "fixed z-40 bottom-10 right-10 px-4 py-2 bg-primary text-white rounded-full shadow-lg hover:bg-emerald-500 transition cursor-pointer sm:right-1 h-10 dark:bg-emerald-500 ",
