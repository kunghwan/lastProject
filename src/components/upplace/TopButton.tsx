  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        "fixed z-40 bottom-30 right-8 md:right-10 lg:right-16 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-emerald-500 transition cursor-pointer h-10  ",
