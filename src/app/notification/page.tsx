          ...
          {data?.pages.map((page) =>
            page.notifications.map((noti) => (
              <li
                ...
                className={twMerge(
                  "hover:[transform:scale(1.02)] hover:shadow-sm hsecol  gap-x-2.5 justify-center p-2.5 rounded-2xl w-full cursor-pointer transition-transform duration-300 ease-in-out [@media(max-width:360px)]:max-w-80 [@media(max-width:390px)]:max-w-[350px]",
                  noti.isRead
